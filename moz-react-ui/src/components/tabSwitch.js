  ...
  render() {
    ...
    return (
      <div id='TabSwitch'>
        ...
        <label htmlFor="tab-target"><img src={portraitImg} alt='tuile' className='tabswitchicon' />Image</label>
        ...
        <label htmlFor="tab-collec"><img src={tilesImg} alt='tuile' className='tabswitchicon' />Tuiles</label>
        ...
        <label htmlFor="tab-preview"><img src={previewImg} alt='tuile' className='tabswitchicon' />Aperçu</label>
        ...
        <label htmlFor="tab-lowres"><img src={mosaicImg} alt='tuile' className='tabswitchicon' />Mosaïque</label>
        ...
        <label htmlFor="tab-hd"><img src={hdmosaicImg} alt='tuile' className='tabswitchicon' />Mosaïque HD</label>
      </div>
    );
  }
}
