  ...
  render() {
    ...
    if (this.props.collections) {
      collectionItems = this.props.collections.map( (collection, i) => {
        let myColl = collection.isMyCollection ? <MyCollection addImageToMyCollection={this.props.addImageToMyCollection} collectionName={collection.name_fr}></MyCollection> : collection.name_fr;
